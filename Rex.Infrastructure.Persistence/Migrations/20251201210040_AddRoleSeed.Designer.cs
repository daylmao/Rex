...
namespace Rex.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251201210040_AddRoleSeed")]
            ...
            modelBuilder.Entity("Rex.Models.GroupRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9ca44144-2f55-4705-8753-85b8b86b7489"),
                            CreatedAt = new DateTime(2025, 12, 1, 21, 0, 39, 453, DateTimeKind.Utc).AddTicks(119),
                            Deleted = false,
                            Role = "Leader"
                        },
                        new
                        {
                            Id = new Guid("a97a1660-afb4-4457-a4e1-bb4164afe397"),
                            CreatedAt = new DateTime(2025, 12, 1, 21, 0, 39, 453, DateTimeKind.Utc).AddTicks(121),
                            Deleted = false,
                            Role = "Mentor"
                        },
                        new
                        {
                            Id = new Guid("b7904eff-7008-4bb7-aea2-44fb27b688ff"),
                            CreatedAt = new DateTime(2025, 12, 1, 21, 0, 39, 453, DateTimeKind.Utc).AddTicks(123),
                            Deleted = false,
                            Role = "Moderator"
                        },
                        new
                        {
                            Id = new Guid("31097fd3-a3c2-409d-9730-8dabffcd04a4"),
                            CreatedAt = new DateTime(2025, 12, 1, 21, 0, 39, 453, DateTimeKind.Utc).AddTicks(125),
                            Deleted = false,
                            Role = "Member"
                        });
                });
            ...
            modelBuilder.Entity("Rex.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a96774e4-170c-4a2a-b87e-d4e3be0d4443"),
                            CreatedAt = new DateTime(2025, 12, 1, 21, 0, 39, 452, DateTimeKind.Utc).AddTicks(9909),
                            Deleted = false,
                            Role = "Admin"
                        },
                        new
                        {
                            Id = new Guid("d7921beb-51e3-459c-9905-c4189cfb31b9"),
                            CreatedAt = new DateTime(2025, 12, 1, 21, 0, 39, 452, DateTimeKind.Utc).AddTicks(9912),
                            Deleted = false,
                            Role = "User"
                        });
                });
